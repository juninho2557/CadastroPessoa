...
public class DisplayUtil {
	...
	public static boolean setWidthHeightByHeight(final View view) {
		...
		if (view != null) {
			...
			if (view.getParent() instanceof ViewPager && param instanceof ViewPager.LayoutParams) {
				...
				LayoutParams params = (LayoutParams) param;
				if (params.width != LayoutParams.WRAP_CONTENT && params.width != LayoutParams.MATCH_PARENT) {
					params.width = calcByHeight(params.width);
				}
				if (params.height != LayoutParams.WRAP_CONTENT && params.height != LayoutParams.MATCH_PARENT) {
	...
	public static android.widget.FrameLayout.LayoutParams getFrameLayoutParams(final LayoutParams view) {

		android.widget.FrameLayout.LayoutParams retView = null;

		if (view instanceof android.widget.FrameLayout.LayoutParams) {
			retView = (android.widget.FrameLayout.LayoutParams) view;
		}

		return retView;
	}
	
	public static android.widget.RelativeLayout.LayoutParams getRelativeLayoutParams(final LayoutParams view) {

		android.widget.RelativeLayout.LayoutParams retView = null;

		if (view instanceof android.widget.RelativeLayout.LayoutParams) {
			retView = (android.widget.RelativeLayout.LayoutParams) view;
		}
